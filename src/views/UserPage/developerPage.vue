...
export default {
  ...
  created() {
    this.name = localStorage.getItem("feedback_name") || "";
    this.phone = localStorage.getItem("feedback_phone") || "";
    this.email = localStorage.getItem("feedback_email") || "";
    this.address = localStorage.getItem("feedback_address") || "";
    this.feedback = localStorage.getItem("feedback_text") || "";
  },
};
</script>
...
<template>
  <div class="mainShowDetail">
    <div class="secondtitle2">
      <h5>
        <RouterLink class="btn" to="/UserPage/Watchfeedback"
          >觀看回饋>
        </RouterLink>
      </h5>
      <h6>
          ...
          <div class="flip-box-inner">
            <div class="flip-box-front">
              <div class="informationTOP">
                ...
                <hr />
                <div class="informationTopLink">
                  <a href="https://github.com/zz0257800000?tab=repositories">
                    <i class="fa-brands fa-github"></i
                  ></a>
                  <a href="https://www.instagram.com/zz025784/"
                    ><i class="fa-brands fa-instagram"></i
                  ></a>
                  <a href="https://www.facebook.com/kami.siyu"
                    ><i class="fa-brands fa-facebook"></i
                  ></a>
                  <a
                    href="https://www.youtube.com/channel/UCIgA5TcL1O_WDHc-CIBk0Tg"
